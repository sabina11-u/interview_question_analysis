# Software Engineering Interview Questions Analysis

## Overview
Analysis of 9,000 software engineering interview questions to identify
trends in topics and difficulty levels across different tech categories.

## Dataset
- Total Questions: 9,000
- Columns: ID, Category, Question, Answer, Difficulty
- Source: Kaggle
